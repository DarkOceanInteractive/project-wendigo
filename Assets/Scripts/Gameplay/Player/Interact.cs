...
namespace ProjectWendigo
{
    public class Interact : MonoBehaviour
    {
        ...
        void Update()
        {
            if (Physics.Raycast(this.transform.position, Camera.main.transform.forward, out RaycastHit hitInfo, this.Reach, LayerMask))
            {
            ...
            else
            {
                ...
                Debug.DrawRay(this.transform.position, Camera.main.transform.forward * Reach, Color.green);
            }
        }
    }
}
